...
class OptionCategory extends MusicBeatSubstate
{
	...
	private var descText:FlxTypeText;
	...
	{		
		...
		descText = new FlxTypeText(50, 600, 1180, "", 32);
	...
	function changeSelection(change:Int = 0)
	{
		...
		descText.y += 270;
		descText.resetText(optionsArray[curSelected].description);
		descText.start(0.01, true);
