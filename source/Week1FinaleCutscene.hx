...
class Week1FinaleCutscene extends MusicBeatSubstate
{
    ...
    {
        dialogue = Utility.coolTextFile(Paths.txt('data/dialogue/weekfinalecutscene'));
        var dialogueBox = new DialogueBox(false, dialogue,true,'dialogueFinaleW1');
