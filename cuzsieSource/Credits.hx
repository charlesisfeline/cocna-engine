...
{
    var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('ui/Backgrounds/GalaxyBG'));
    ...
    [
        ...
        (
            "Cuzsie", 
            "Dev", 
            "Director, Creator, Programmer, Musician, Main Developer",
            [
                new Social('youtube', 'https://www.youtube.com/channel/UCVMwtK4nn6o6E5kMzIgSiIA'), 
        ...
        (
            ...
            "Musician",
            [
                new Social('youtube', 'https://www.youtube.com/c/PeashooterTheGamer'),
            ]
        ),
	...
	override function create()
	{
        ...
        defaultFormat = new FlxText().setFormat(Paths.font("opensans.ttf"), 32, FlxColor.WHITE, CENTER);
        selectedFormat = new FlxText().setFormat(Paths.font("opensans.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
        ...
        for (i in 0...peopleInCredits.length)
        {
            ...
            if (currentPerson == developers[0] || currentPerson == contributors[0] || currentPerson == betaTesters[0])
            {
                ...
                titleText.setFormat(Paths.font("opensans.ttf"), 64, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
class Person
{
    ...
    public var creditsType:String;
    public var credits:String;
    public var socialMedia:Array<Social>;

	public function new(name:String, creditsType:String, credits:String, socialMedia:Array<Social>)
	{
        this.name = name;
