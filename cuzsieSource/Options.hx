...
class DownscrollOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.downscroll ? "Scroll: Reverse" : "Scroll: Default";
	}
}
...
class SongPositionOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Song Progress Bar " + (!FlxG.save.data.songPosition ? "OFF" : "ON");
	}
}
...
class SuddenDeathOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	private override function updateDisplay():String
	{
		return "Sudden Death - " + (!FlxG.save.data.suddendeath ? "OFF" : "ON");
	}
}

class AmplifiedMisses extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.ampmiss = !FlxG.save.data.ampmiss;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Amplified Misses - " + (!FlxG.save.data.ampmiss ? "OFF" : "ON");
	}
}

class WindowEffects extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.windoweffects = !FlxG.save.data.windoweffects;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Windowed Effects - " + (!FlxG.save.data.windoweffects ? "OFF" : "ON");
	}
}

class FourthWall extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.fourthwallbreaksoff = !FlxG.save.data.fourthwallbreaksoff;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Fourth Wall Breaks - " + (!FlxG.save.data.windoweffects ? "ON" : "OFF");
	}
}
...
class NoMissOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "No Misses - " + (!FlxG.save.data.nomiss ? "OFF" : "ON");
	}
}
...
class ShowInput extends Option
{
	...
	private override function updateDisplay():String
	{
		return (FlxG.save.data.inputShow ? "Extended Info ON" : "Extended Info OFF");
	}
}
...
class ScoreScreen extends Option
{
	...
	private override function updateDisplay():String
	{
		return (FlxG.save.data.scoreScreen ? "Results ON" : "Results OFF");
	}
}
...
class ScrollSpeedOption extends Option
{
	...
	override function getValue():String {
		if (FlxG.save.data.scrollSpeed == 1)
		{
			return "Current Scroll Speed " + "Chart Dependent";
		}
		else
		{
...
class AccuracyDOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Complex Accuracy" + (FlxG.save.data.accuracyMod == 0 ? "OFF" : "ON");
	}
}
...
class WatermarkOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Labels " + (Main.watermarks ? "OFF" : "ON");
	}
}
...
class BotPlay extends Option
{
	...
	public override function press():Bool
	{
		...
		trace('Auto : ' + FlxG.save.data.botplay);
		display = updateDisplay();
		return true;
	}
	
	private override function updateDisplay():String
		return "Auto " + (FlxG.save.data.botplay ? "on" : "off");
}
